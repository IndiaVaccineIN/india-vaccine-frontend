        ...
        <>
            <div className={styles.landing_wrapper}>
                <div className={styles.landingText}>
                    <h1>
                        {data?.we} <span className={styles.greenUnderline}> {data?.making} </span>{data?.locate}
                    </h1>
                    ...
                    <div className={styles.button_wrapper}>
                        ...
                        <a href="#how">
                            <Button type={"outline"}> <div>{data?.learn} </div></Button>
                        </a>
                    </div>
            ...
            <div className={styles.landing_wrapper}>
                <div className={styles.landingText}>
                    ...
                    <p> <b> 1. {data?.tech} </b> {data?.techteam} </p>
                    <p> <b>2. {data?.calling}</b> {data?.callteam} </p>
