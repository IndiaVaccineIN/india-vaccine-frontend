...
Directions</a>
            ...
            <br />
            <div className={styles.subText}>
                <a href={"https://selfregistration.cowin.gov.in/"} rel="noreferrer noopener" target="_blank">
